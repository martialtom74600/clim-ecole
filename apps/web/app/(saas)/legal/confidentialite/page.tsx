...
export default function ConfidentialitePage() {
  return (
    <div className="page-content max-w-3xl">
      ...
      <div className="mt-8 space-y-6 text-radar-muted">
        <section>
          <h2 className="text-lg font-semibold text-radar-text">Données que nous collectons</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-radar-text">Données publiques</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-radar-text">Vos droits</h2>
          <p className="mt-2">
        ...
        <p>
          Contact :{' '}
          <a href="mailto:contact@strate.studio" className="text-radar-signal">
