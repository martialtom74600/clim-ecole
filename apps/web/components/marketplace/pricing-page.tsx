...
/**
 * PricingPage — pas de page-content propre, géré par tarifs/page.tsx.
 * Tokens radar-* remplacés par tokens sémantiques.
 */
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {PRICING_TIERS.map((plan) => {
          ...
          >
            ...
            <p className={cn('mt-4 font-mono text-3xl font-semibold tabular-nums', flagship ? 'text-white' : 'text-ink')}>
              {plan.price}
